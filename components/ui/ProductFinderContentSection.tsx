...
const ProductFinderContentSection: React.FC = () => {
  return (
    <div
      ...
      className="line-height-[1.15] text-size-adjust-[100%] font-sans font-normal font-size-[16px] color-[#222] bg-gray-100 box-border min-w-[0] py-[0.5rem] pb-[4rem] "
    >
      ...
      <div className="p-6 mt-8 text-center max-w-2xl mx-auto">
        ...
        <Button
          variant="default"
          className="bg-[#3c3c3c] text-[#ffffff] bold mt-2 rounded-none	"
        >
